...
#define MYSQL_RPL_REVERSE_RECOVER_PLUGIN  9 /*replication reverse recover plugin typr*/
 ...
 */
 ...
 /*
   API for Replication reverse recovery plugin.
 */

 #define MYSQL_RPL_REVERSE_REVOVER_INTERFACE_VERSION 0x0100
